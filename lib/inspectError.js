...
module.exports = function inspectError(errCode, file, route, method, ignoreInvalid, invalid) {
    ...
    if (errCode === 0) {
        ...
        if (errCode === 1) {
            ...
            error.msg = 'File "' + file + '" has definition of the route: "' + route + '" for the "' + method.toUpperCase() + '" method that has been already applied to application.';
        }
